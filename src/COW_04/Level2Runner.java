...
public class Level2Runner extends JPanel implements ActionListener, MouseListener, KeyListener
{
    ...
    public Level2Runner(JFrame theFrame){

        setLayout(null);
        blockSize = 30;
        mapLoaded = false;

        test1Button = new Button("Test Move To Fruit");
        test1Button.setBounds(0, 0, 200, blockSize);
        test1Button.setBackground(Color.WHITE);
        test1Button.setActionCommand("Test Move To Fruit");
        add(test1Button);
        test1Button.addActionListener(this);

        test2Button = new Button("Test Pick Fruit");
        test2Button.setBounds(200, 0, 200, blockSize);
        test2Button.setBackground(Color.WHITE);
        test2Button.setActionCommand("Test Pick Fruit");
        add(test2Button);
    ...
    public void actionPerformed (ActionEvent event)
    {
        ...
        if(command.equals("Test Pick Fruit")){
    ...
    public static void main(String [] arg){
        ...
        Level2Runner game = new Level2Runner(frame);
