...
public class Level3Tester
{
    ...
    public static boolean testMyDateLevel3(){
        ...
        if(success){
            System.out.println("MyDate Level 3 works");
        }else{
            System.out.println("MyDate Level 3 does NOT work");
        }
        return success;
    ...
    public static boolean testNameLevel3(){
        ...
        if(!centerName.equals(centerName2)){
            success = false;
            System.out.println("Name equals not set up correctly! False negative");
            System.out.println("Name 1: " + centerName + ",    Other Name: " + centerName2);
        }

        if(centerName.compareTo(centerName2) != 0){
            success = false;
            System.out.println("Name compareTo not set up correctly! Equality not working");
            System.out.println("Name 1: " + centerName + ",    Other Name: " + centerName2);
        ...
        for(Name nextName : beforeNames){
            if(centerName.equals(nextName)){
                success = false;
                System.out.println("Name equals not set up correctly!, False positive for equality");
                System.out.println("Name 1: " + centerName + ",    Other Name: " + nextName);
            }

            if(centerName.compareTo(nextName) <= 0){
                success = false;
                System.out.println("Name compareTo not set up correctly!, Negative expected");
                System.out.println("Name 1: " + centerName + ",    Other Name: " + nextName);
        ...
        for(Name nextName : afterNames){
            ...
            if(centerName.compareTo(nextName) >= 0){
                success = false;
                System.out.println("Name compareTo not set up correctly!, Positive expected");
                System.out.println("Name 1: " + centerName + ",    Other Name: " + nextName);
                System.out.println("Returns: " + centerName.compareTo(nextName));
            }
        }
        ...
        if(success){
            System.out.println("Name Level 3 works");
        }else{
            System.out.println("Name Level 3 does NOT work");
        }
        return success;
    }
    ...
    public static boolean testPointLevel3(){
        ...
        if(output){
            System.out.println("Point Level 3 works");
        }else{
            System.out.println("Point Level 3 does NOT work");
        }
        return output;
    }
