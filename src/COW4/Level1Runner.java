...
public class Level1Runner extends JPanel implements ActionListener, MouseListener, KeyListener
{
    ...
    public Level1Runner(JFrame theFrame){

        setLayout(null);
        blockSize = 30;
        mapLoaded = false;

        test1Button = new Button("Test Move(steps)");
        ...
        test2Button = new Button("Test Move To Wall");
    ...
    public static void main(String [] arg){
        ...
        Level1Runner game = new Level1Runner(frame);
