...
public class StatisticalCalcTester {
    ...
    public static boolean testGetAverageValue() {
        ...
        StatisticalCalculator student = new StatisticalCalculator();
        double[] input = {4, 1, 8, 11, 13, 10, 7, 5, 15, 1};
        double ave1 = StatisticalCalculator.getAverageValue(input);
        if (ave1 != 7.5) {
            verified = false;
            System.out.println("getAverageValue({4, 1, 8, 11, 13, 10, 7, 5, 15, 1}) returns " + ave1 + ", not 7.5");
        }
        double[] input2 = {3, 2, 10, 10, 12, 11, 7, 4, 17, 0};
        double ave2 = StatisticalCalculator.getAverageValue(input2);
        if (ave2 != 7.6) {
            verified = false;
    ...
    public static boolean testGetMedianValue() {
        ...
        double median1 = StatisticalCalculator.getMedianValue(input);
        if (median1 != 10) {
            verified = false;
        ...
        double median2 = StatisticalCalculator.getMedianValue(input2);
        if (median2 != 9.5) {
            verified = false;
    ...
    public static boolean testStandardDeviation() {
        ...
        double[] input = {4, 1, 8, 11, 13, 10, 7, 5, 15, 1};
        double dev1 = StatisticalCalculator.standardDeviation(input);
        ...
        double[] input2 = {3, 2, 10, 10, 12, 11, 7, 4, 17, 0};
        double dev2 = StatisticalCalculator.standardDeviation(input2);
    ...
    public static boolean testGetDeviations() {
        ...
        double[] deviations = StatisticalCalculator.getDeviations(input);
    ...
    public static boolean testGetCorrelation() {
        ...
        double corr1 = StatisticalCalculator.getCorrelation(x1s, y1s);
        ...
        double corr2 = StatisticalCalculator.getCorrelation(x2s, y2s);
        ...
        double corr3 = StatisticalCalculator.getCorrelation(x3s, y3s);
        ...
        double corr4 = StatisticalCalculator.getCorrelation(x4s, y4s);
