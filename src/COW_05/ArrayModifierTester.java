...
public class ArrayModifierTester extends JPanel implements KeyListener {
    ...
    public static boolean testFlip() {
        ...
        double[] output = ArrayModifier.flip(input);
    ...
    public static boolean testAmplify() {
        ...
        double[] output = ArrayModifier.amplify(input, 3);
        for (int i = 0; i < output.length; i++) {
            if (Math.abs(correctOutput[i] - output[i]) > .000001) {
                verified = false;
    ...
    public static boolean testCap() {
        ...
        double[] output = ArrayModifier.cap(input, -7, 5);
        for (int i = 0; i < output.length; i++) {
            if (Math.abs(correctOutput[i] - output[i]) > .000001) {
                verified = false;
    ...
    public static boolean testAverageElements() {
        ...
        double[] output = ArrayModifier.averageElements(input1, input2);
        for (int i = 0; i < output.length; i++) {
            if (Math.abs(correctOutput[i] - output[i]) > .000001) {
                verified = false;
    ...
    public static boolean testEvenOut() {
        ...
        double[] output = ArrayModifier.evenOut(input1);
        for (int i = 0; i < output.length; i++) {
            if (Math.abs(correctOutput[i] - output[i]) > .000001) {
                verified = false;
    ...
    public static boolean testCompress() {
        ...
        double[] output = ArrayModifier.compress(input1);
        for (int i = 0; i < output.length; i++) {
            if (Math.abs(correctOutput[i] - output[i]) > .000001) {
                verified = false;
        ...
        double[] output2 = ArrayModifier.compress(input2);
