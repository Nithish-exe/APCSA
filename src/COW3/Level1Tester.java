...
public class Level1Tester
{
    ...
    public static boolean testMyDateLevel1(){
        ...
        if(output){
            System.out.println("MyDate Level 1 works");
        }else{

            System.out.println("MyDate Level 1 does NOT work");
        }
        return output;
    }
    ...
    public static boolean testNameLevel1(){
        ...
        if(output){
            System.out.println("Name Level 1 works");
        }else{
            System.out.println("Name Level 1 does NOT work");
        }
        return output;
    }
    ...
    public static boolean testPointLevel1(){
        ...
        if(output){
            System.out.println("Point Level 1 works");
        }else{

            System.out.println("Point Level 1 does NOT work");
        }
        return output;
    }
