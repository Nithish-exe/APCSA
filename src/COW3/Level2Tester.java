    ...
    public static boolean testMyDateLevel2(){
        ...
        for(int i = 0; i < days.length; i++){
            if(!dates[i].toString().equals(texts[i])){
                System.out.println("MyDate toString method is incorrect, returning " + dates[i].toString() + "  , should be " + texts[i]);
                output = false;
            }
        ...
        if(output){
            System.out.println("MyDate Level 2 works");
        }else{
            System.out.println("MyDate Level 2 does NOT work");
        }
        return output;
    }
    ...
    public static boolean testNameLevel2(){
        ...
        for(int i = 0; i < lastNames.length; i++){
            if(!names[i].toString().equals(texts[i])){
                System.out.println("Name toString method is incorrect, returning " + names[i].toString() + "  , should be " + texts[i]);
                output = false;
            }
        }

        if(output){
            System.out.println("Name Level 2 works");
        }else{
            System.out.println("Name Level 2 does NOT work");
        }
        return output;
    }
    ...
    public static boolean testPointLevel2(){
        ...
        for(int n = 0; n < 5; n++){
            ...
            if(thePoint.getX() != x || thePoint.getY() != y){
                System.out.println("the moveRight method of the Point Class does not appear to work");
                output = false;
            }
        }
        for(int n = 0; n < 5; n++){
            ...
            if(thePoint.getX() != x || thePoint.getY() != y){
                System.out.println("the moveLeft method of the Point Class does not appear to work");
                output = false;
            }
        }
        for(int n = 0; n < 5; n++){
            ...
            if(thePoint.getX() != x || thePoint.getY() != y){
                System.out.println("the moveUp method of the Point Class does not appear to work");
                output = false;
            }
        }
        for(int n = 0; n < 5; n++){
            ...
            if(thePoint.getX() != x || thePoint.getY() != y){
                System.out.println("the moveDown method of the Point Class does not appear to work");
                output = false;
            }
        }
        for(int n = 0; n < 5; n++){
            ...
            thePoint.moveTo(x, y);
            if(thePoint.getX() != x || thePoint.getY() != y){
                System.out.println("the moveTo method of the Point Class does not appear to work");
                output = false;
            }
        }
        ...
        if(output){
            System.out.println("Point Level 2 works");
        }else{

            System.out.println("Point Level 2 does NOT work");
        }
        return output;
    }
